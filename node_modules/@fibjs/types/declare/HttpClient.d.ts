...
declare class Class_HttpClient extends Class__object {
	 ...
	 * @async
	 */
	request(conn: Class_Stream, req: Class_HttpRequest, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	request(method: string, url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	get(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	post(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	del(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	put(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	/**
	 ...
	 * @async
	 */
	patch(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
} /** endof class */
