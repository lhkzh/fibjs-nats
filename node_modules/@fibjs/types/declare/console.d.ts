...
declare module "console" {
	module console {
		 ...
		 * @async
		 */
		export function readLine(msg?: string/** = ""*/, callback?:(err: Error, result: string)=>void): string;
		/**
		 * @brief 从控制台读取用户输入的密码
		 * @param msg 提示信息
		 * @return 返回用户输入的密码
		 * @async
		 */
		export function getpass(msg?: string/** = ""*/, callback?:(err: Error, result: string)=>void): string;
