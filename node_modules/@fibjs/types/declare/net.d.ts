...
declare module "net" {
	module net {
		 ...
		 * @async
		 */
		export function resolve(name: string, family?: number/** = undefined*/, callback?:(err: Error, result: string)=>void): string;
		/**
		 ...
		 * @async
		 */
		export function ip(name: string, callback?:(err: Error, result: string)=>void): string;
		/**
		 ...
		 * @async
		 */
		export function ipv6(name: string, callback?:(err: Error, result: string)=>void): string;
		/**
		 ...
		 * @async
		 */
		export function connect(url: string, timeout?: number/** = 0*/, callback?:(err: Error, result: Class_Stream)=>void): Class_Stream;
		/**
		 ...
		 * @async
		 */
		export function openSmtp(url: string, timeout?: number/** = 0*/, callback?:(err: Error, result: Class_Smtp)=>void): Class_Smtp;
		/**
		 * @brief 查询当前系统异步网络引擎
		 * @return 返回网络引擎名称
		 */
