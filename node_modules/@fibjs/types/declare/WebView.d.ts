...
declare class Class_WebView extends Class_EventEmitter {
	 ...
	 * @async
	 */
	setHtml(html: string, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 打印当前窗口文档
	 * @param mode 打印参数，0: 快速打印; 1: 标准打印; 2: 打印预览。缺省为 1
	 * @async
	 */
	print(mode?: number/** = 1*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 关闭当前窗口
	 * @async
	 */
	 ...
	 * @async
	 */
	postMessage(msg: string, callback?:(err: Error, result: void)=>void): void;
} /** endof class */
