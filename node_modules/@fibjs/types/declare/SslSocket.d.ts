...
declare class Class_SslSocket extends Class_Stream {
	 ...
	 * @async
	 */
	connect(s: Class_Stream, server_name?: string/** = ""*/, callback?:(err: Error, result: number)=>void): number;
	/**
	 ...
	 * @async
	 */
	accept(s: Class_Stream, callback?:(err: Error, result: Class_SslSocket)=>void): Class_SslSocket;
} /** endof class */
