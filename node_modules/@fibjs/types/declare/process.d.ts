...
declare module "process" {
	module process {
		 ...
		 * @async
		 */
		export function run(command: string, args: any[], opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: number)=>void): number;
		/**
		 * @brief 运行指定的命令行，并返回进程的结束代码
		 * opts 支持的选项如下：
		 * ```JavaScript
		 ...
		 * @async
		 */
		export function run(command: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: number)=>void): number;
