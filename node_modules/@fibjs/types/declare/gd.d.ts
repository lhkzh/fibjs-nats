...
declare module "gd" {
	module gd {
		 ...
		 * @async
		 */
		export function create(width: number, height: number, color?: number/** = undefined*/, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
		/**
		 * @brief 从格式数据中解码图像
		 ...
		 * @async
		 */
		export function load(data: Class_Buffer, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
		/**
		 * @brief 从流对象中解码图像
		 ...
		 * @async
		 */
		export function load(stm: Class_SeekableStream, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
		/**
		 * @brief 从指定文件中解码图像
		 * @param fname 指定文件名
		 * @return 返回解码成功的图像对象
		 * @async
		 */
		export function load(fname: string, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
		/**
