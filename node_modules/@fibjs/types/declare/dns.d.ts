...
declare module "dns" {
	module dns {
		 ...
		 * @async
		 */
		export function resolve(name: string, callback?:(err: Error, result: any[])=>void): any[];
		/**
		 * @brief 查询给定的主机名的地址
		 * @param name 指定主机名
		 * @return 返回查询的 ip 字符串
		 * @async
		 */
		export function lookup(name: string, callback?:(err: Error, result: string)=>void): string;
	} /** end of `module dns` */
	export = dns
}
