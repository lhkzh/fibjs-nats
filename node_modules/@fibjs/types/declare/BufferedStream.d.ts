...
declare class Class_BufferedStream extends Class_Stream {
	 ...
	 * @async
	 */
	readText(size: number, callback?:(err: Error, result: string)=>void): string;
	/**
	 ...
	 * @async
	 */
	readLine(maxlen?: number/** = -1*/, callback?:(err: Error, result: string)=>void): string;
	/**
	 ...
	 * @async
	 */
	readUntil(mk: string, maxlen?: number/** = -1*/, callback?:(err: Error, result: string)=>void): string;
	/**
	 * @brief 写入一个字符串
	 * @param txt 指定写入的字符串
	 * @async
	 */
	writeText(txt: string, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 写入一个字符串，并写入换行符
	 * @param txt 指定写入的字符串
	 * @async
	 */
	writeLine(txt: string, callback?:(err: Error, result: void)=>void): void;
} /** endof class */
