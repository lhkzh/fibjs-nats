...
declare class Class_MongoCursor extends Class__object {
	 ...
	 * @async
	 */
	skip(num: number, callback?:(err: Error, result: Class_MongoCursor)=>void): Class_MongoCursor;
	/**
	 * @brief 指定返回结果的最大记录数
	 * @param size 记录数
	 * @return 返回游标对象本身便于链式调用
	 * @async
	 */
	limit(size: number, callback?:(err: Error, result: Class_MongoCursor)=>void): Class_MongoCursor;
	/**
	 * @brief 设定返回结果的排序
	 * @param opts 指定排序条件
	 * @return 返回游标对象本身便于链式调用
