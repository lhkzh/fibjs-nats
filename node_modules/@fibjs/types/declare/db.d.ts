...
declare module "db" {
	module db {
		 ...
		 * @async
		 */
		export function open(connString: string, callback?:(err: Error, result: Class__object)=>void): Class__object;
		/**
		 ...
		 * @async
		 */
		export function openMySQL(connString: string, callback?:(err: Error, result: Class_MySQL)=>void): Class_MySQL;
		/**
		 * @brief 打开一个 mysql 数据库
		 ...
		 * @async
		 */
		export function openMSSQL(connString: string, callback?:(err: Error, result: Class_MSSQL)=>void): Class_MSSQL;
		/**
		 ...
		 * @async
		 */
		export function openSQLite(connString: string, callback?:(err: Error, result: Class_SQLite)=>void): Class_SQLite;
		/**
		 ...
		 * @async
		 */
		export function openMongoDB(connString: string, callback?:(err: Error, result: Class_MongoDB)=>void): Class_MongoDB;
		/**
		 ...
		 * @async
		 */
		export function openLevelDB(connString: string, callback?:(err: Error, result: Class_LevelDB)=>void): Class_LevelDB;
		/**
		 ...
		 * @async
		 */
		export function openRedis(connString: string, callback?:(err: Error, result: Class_Redis)=>void): Class_Redis;
		/**
