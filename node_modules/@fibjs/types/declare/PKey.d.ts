...
declare class Class_PKey extends Class__object {
	 ...
	 * @async
	 */
	genRsaKey(size: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 生成一个 EC 私钥
	 ...
	 * @async
	 */
	genEcKey(curve?: string/** = "secp521r1"*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 查询当前密钥是否为私钥
	 * @return 为 True 表示为私钥
	 */
	 ...
	 * @async
	 */
	encrypt(data: Class_Buffer, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
	/**
	 ...
	 * @async
	 */
	decrypt(data: Class_Buffer, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
	/**
	 ...
	 * @async
	 */
	sign(data: Class_Buffer, alg?: number/** = 0*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
	/**
	 ...
	 * @async
	 */
	verify(data: Class_Buffer, sign: Class_Buffer, alg?: number/** = 0*/, callback?:(err: Error, result: boolean)=>void): boolean;
} /** endof class */
