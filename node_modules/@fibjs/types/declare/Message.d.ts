...
declare class Class_Message extends Class__object {
	 ...
	 * @async
	 */
	read(bytes?: number/** = -1*/, callback?:(err: Error, result: Class_Buffer|string)=>void): Class_Buffer;
	/**
	 ...
	 * @async
	 */
	write(data: Class_Buffer|string, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	sendTo(stm: Class_Stream, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 从给定的缓存流对象中读取格式化消息，并解析填充对象
	 * @param stm 指定读取格式化消息的流对象
	 * @async
	 */
	readFrom(stm: Class_Stream, callback?:(err: Error, result: void)=>void): void;
} /** endof class */
