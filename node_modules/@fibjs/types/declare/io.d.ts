...
declare module "io" {
	module io {
		 ...
		 * @async
		 */
		export function copyStream(from: Class_Stream, to: Class_Stream, bytes?: number/** = -1*/, callback?:(err: Error, result: number)=>void): number;
		/**
		 ...
		 * @async
		 */
		export function bridge(stm1: Class_Stream, stm2: Class_Stream, callback?:(err: Error, result: void)=>void): void;
	} /** end of `module io` */
	export = io
}
