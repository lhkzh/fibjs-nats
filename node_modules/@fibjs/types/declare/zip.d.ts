...
declare module "zip" {
	module zip {
		 ...
		 * @async
		 */
		export function isZipFile(filename: string, callback?:(err: Error, result: boolean)=>void): boolean;
		/**
		 * @brief 打开一个zip文件
		 * @param path 文件路径
		 ...
		 * @async
		 */
		export function open(path: string, mod?: string/** = "r"*/, compress_type?: number/** = undefined*/, callback?:(err: Error, result: Class_ZipFile)=>void): Class_ZipFile;
		/**
		 * @brief 打开一个zip文件
		 * @param data zip文件数据
		 * @param mod 打开文件模式, "r"代表读取, "w"代表创建, "a"代表在zip文件后追加
		 ...
		 * @async
		 */
		export function open(data: Class_Buffer, mod?: string/** = "r"*/, compress_type?: number/** = undefined*/, callback?:(err: Error, result: Class_ZipFile)=>void): Class_ZipFile;
		/**
		 * @brief 打开一个zip文件
		 * @param strm zip文件流
		 * @param mod 打开文件模式, "r"代表读取, "w"代表创建, "a"代表在zip文件后追加
		 ...
		 * @async
		 */
		export function open(strm: Class_SeekableStream, mod?: string/** = "r"*/, compress_type?: number/** = undefined*/, callback?:(err: Error, result: Class_ZipFile)=>void): Class_ZipFile;
	} /** end of `module zip` */
	export = zip
}
