...
declare module "crypto" {
	module crypto {
		 ...
		 * @return 返回信息摘要对象
		 */
		export function createHmac(algo: string, key: Class_Buffer|string): Class_Digest;
		/**
		 ...
		 * @async
		 */
		export function randomBytes(size: number, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function simpleRandomBytes(size: number, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function pseudoRandomBytes(size: number, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function pbkdf1(password: Class_Buffer, salt: Class_Buffer, iterations: number, size: number, algo: number, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 * @brief 依据 pbkdf1 根据明文 password 生成要求的二进制钥匙
		 * @param password 指定使用的密码
		 * @param salt 指定 hmac 使用的 salt
		 ...
		 * @async
		 */
		export function pbkdf1(password: Class_Buffer, salt: Class_Buffer, iterations: number, size: number, algoName: string, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function pbkdf2(password: Class_Buffer, salt: Class_Buffer, iterations: number, size: number, algo: number, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 * @brief 依据 rfc2898 根据明文 password 生成要求的二进制钥匙
		 * @param password 指定使用的密码
		 * @param salt 指定 hmac 使用的 salt
		 ...
		 * @async
		 */
		export function pbkdf2(password: Class_Buffer, salt: Class_Buffer, iterations: number, size: number, algoName: string, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
