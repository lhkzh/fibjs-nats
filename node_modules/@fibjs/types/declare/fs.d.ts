...
declare module "fs" {
	module fs {
		 ...
		 * @async
		 */
		export function exists(path: string, callback?:(err: Error, result: boolean)=>void): boolean;
		/**
		 * @brief 查询用户对指定的文件的权限
		 * @param path 指定要查询的路径
		 ...
		 * @async
		 */
		export function access(path: string, mode?: number/** = 0*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function link(oldPath: string, newPath: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 删除指定的文件
		 * @param path 指定要删除的路径
		 * @async
		 */
		export function unlink(path: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 创建一个目录
		 ...
		 * @async
		 */
		export function mkdir(path: string, mode?: number/** = 0777*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 删除一个目录
		 * @param path 指定要删除的目录名
		 * @async
		 */
		export function rmdir(path: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 重新命名一个文件
		 * @param from 指定更名的文件
		 * @param to 指定要修改的新文件名
		 * @async
		 */
		export function rename(from: string, to: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 复制一个文件
		 * @param from 指定更名的文件
		 * @param to 指定要修改的新文件名
		 * @async
		 */
		export function copy(from: string, to: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function chmod(path: string, mode: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function lchmod(path: string, mode: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function chown(path: string, uid: number, gid: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function lchown(path: string, uid: number, gid: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 查询指定文件的基础信息
		 * @param path 指定查询的文件
		 * @return 返回文件的基础信息
		 * @async
		 */
		export function stat(path: string, callback?:(err: Error, result: Class_Stat)=>void): Class_Stat;
		/**
		 ...
		 * @async
		 */
		export function lstat(path: string, callback?:(err: Error, result: Class_Stat)=>void): Class_Stat;
		/**
		 ...
		 * @async
		 */
		export function readlink(path: string, callback?:(err: Error, result: string)=>void): string;
		/**
		 ...
		 * @async
		 */
		export function realpath(path: string, callback?:(err: Error, result: string)=>void): string;
		/**
		 * @brief 创建软连接文件
		 ...
		 * @async
		 */
		export function symlink(target: string, linkpath: string, type?: string/** = "file"*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function truncate(path: string, len: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function read(fd: number, buffer: Class_Buffer, offset?: number/** = 0*/, length?: number/** = 0*/, position?: number/** = -1*/, callback?:(err: Error, result: number)=>void): number;
		/**
		 ...
		 * @async
		 */
		export function fchmod(fd: number, mode: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function fchown(fd: number, uid: number, gid: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 根据文件描述符，同步数据到磁盘
		 * @param fd 文件描述符
		 * @async
		 */
		export function fdatasync(fd: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 根据文件描述符，同步数据到磁盘
		 * @param fd 文件描述符
		 * @async
		 */
		export function fsync(fd: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 读取指定目录的文件信息
		 * @param path 指定查询的目录
		 * @return 返回目录的文件信息数组
		 * @async
		 */
		export function readdir(path: string, callback?:(err: Error, result: any[])=>void): any[];
		/**
		 ...
		 * @async
		 */
		export function openFile(fname: string, flags?: string/** = "r"*/, callback?:(err: Error, result: Class_SeekableStream)=>void): Class_SeekableStream;
		/**
		 * @brief 打开文件描述符
		 * 参数 flags 支持的方式如下：
		 * - 'r' 只读方式，文件不存在则抛出错误。
		 ...
		 * @async
		 */
		export function open(fname: string, flags?: string/** = "r"*/, mode?: number/** = 0666*/, callback?:(err: Error, result: number)=>void): number;
		/**
		 * @brief 关闭文件描述符
		 * @param fd 文件描述符
		 * @async
		 */
		export function close(fd: number, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function openTextStream(fname: string, flags?: string/** = "r"*/, callback?:(err: Error, result: Class_BufferedStream)=>void): Class_BufferedStream;
		/**
		 * @brief 打开文本文件，并读取内容
		 * @param fname 指定文件名
		 * @return 返回文件文本内容
		 * @async
		 */
		export function readTextFile(fname: string, callback?:(err: Error, result: string)=>void): string;
		/**
		 * @brief 打开二进制文件，并读取内容
		 * @param fname 指定文件名
		 ...
		 * @async
		 */
		export function readFile<T_RESULT = any>(fname: string, encoding?: string/** = ""*/, callback?:(err: Error, result: T_RESULT)=>void): T_RESULT;
		/**
		 ...
		 * @async
		 */
		export function writeTextFile(fname: string, txt: string, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 创建二进制文件，并写入内容
		 * @param fname 指定文件名
		 ...
		 * @async
		 */
		export function writeFile(fname: string, data: Class_Buffer, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 创建二进制文件，并写入内容
		 * @param fname 指定文件名
		 * @param data 指定要写入的二进制数据
		 * @async
		 */
		export function appendFile(fname: string, data: Class_Buffer, callback?:(err: Error, result: void)=>void): void;
		/**
		 * @brief 设置 zip 虚拟文件映射
		 * @param fname 指定映射路径
