...
declare class Class_Redis extends Class__object {
	 ...
	 */
	set(key: Class_Buffer|string, value: Class_Buffer, ttl?: number/** = 0*/): void;
	/**
	 ...
	 * @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间
	 */
	setNX(key: Class_Buffer|string, value: Class_Buffer, ttl?: number/** = 0*/): void;
	/**
	 ...
	 * @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间
	 */
	setXX(key: Class_Buffer|string, value: Class_Buffer, ttl?: number/** = 0*/): void;
	/**
	 ...
	 * @return 被设置为 1 的位的数量
	 */
	bitcount(key: Class_Buffer|string, start?: number/** = 0*/, end?: number/** = -1*/): number;
	/**
	 ...
	 */
	decr(key: Class_Buffer|string, num?: number/** = 1*/): number;
	/**
	 ...
	 */
	incr(key: Class_Buffer|string, num?: number/** = 1*/): number;
	/**
	 ...
	 * @param func 指定回调函数
	 */
	sub(channel: Class_Buffer|string, func: Function): void;
	/**
	 ...
	 */
	unsub(channel: Class_Buffer|string, func: Function): void;
	/**
	 ...
	 * @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间
	 */
	restore(key: Class_Buffer|string, data: Class_Buffer, ttl?: number/** = 0*/): void;
	/**
	 * @brief 关闭当前数据库连接或事务
	 */
	close(): void;
