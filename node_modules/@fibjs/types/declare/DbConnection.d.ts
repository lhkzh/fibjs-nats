...
declare class Class_DbConnection extends Class__object {
	 ...
	 * @async
	 */
	insert(opts: Fibjs.AnyObject, callback?:(err: Error, result: number)=>void): number;
	/**
	 * @brief 根据指定的条件查询数据
	 * @param opts 参数列表
	 * @return 返回包含结果记录
	 * @async
	 */
	find(opts: Fibjs.AnyObject, callback?:(err: Error, result: any[])=>void): any[];
	/**
	 ...
	 * @async
	 */
	count(opts: Fibjs.AnyObject, callback?:(err: Error, result: number)=>void): number;
	/**
	 * @brief 根据指定的条件更新数据
	 * @param opts 参数列表
	 * @return 返回包含更新的记录数
	 * @async
	 */
	update(opts: Fibjs.AnyObject, callback?:(err: Error, result: number)=>void): number;
	/**
	 * @brief 根据指定的条件删除数据
	 * @param opts 可选参数列表
	 * @return 返回包含更新的记录数
	 * @async
	 */
	remove(opts: Fibjs.AnyObject, callback?:(err: Error, result: number)=>void): number;
	/**
