...
declare module "hash" {
	module hash {
		 ...
		 * @return 返回构造的信息摘要对象
		 */
		export function digest(algo: number, data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 根据指定的算法标识创建一个信息摘要运算对象
		 * @param algo 指定摘要运算算法
		 * @return 返回构造的信息摘要对象
		 ...
		 * @return 返回构造的信息摘要对象
		 */
		export function md2(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 MD4 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function md4(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 MD5 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function md5(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA1 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function sha1(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA224 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function sha224(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA256 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function sha256(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA384 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function sha384(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA512 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function sha512(data: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 RIPEMD160 信息摘要运算对象
		 * @param data 创建同时更新的二进制数据
		 * @return 返回构造的信息摘要对象
		 */
		export function ripemd160(data: Class_Buffer|string): Class_Digest;
		/**
		 ...
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac(algo: number, key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 MD2 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_md2(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 MD4 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_md4(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 MD5 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_md5(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA1 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_sha1(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA224 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_sha224(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA256 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_sha256(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA384 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_sha384(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 SHA512 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_sha512(key: Class_Buffer|string): Class_Digest;
		/**
		 * @brief 创建一个 RIPEMD160 信息摘要签名运算对象
		 * @param key 二进制签名密钥
		 * @return 返回构造的信息摘要对象
		 */
		export function hmac_ripemd160(key: Class_Buffer|string): Class_Digest;
	} /** end of `module hash` */
	export = hash
}
