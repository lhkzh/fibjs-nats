...
declare module "http" {
	module http {
		 ...
		 * @async
		 */
		export function request(conn: Class_Stream, req: Class_HttpRequest, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function request(method: string, url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function get(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function post(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function del(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function put(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
		/**
		 ...
		 * @async
		 */
		export function patch(url: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?:(err: Error, result: Class_HttpResponse)=>void): Class_HttpResponse;
	} /** end of `module http` */
	export = http
}
