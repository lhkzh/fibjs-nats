...
declare class Class_Image extends Class__object {
	 ...
	 * @async
	 */
	getData(format?: number/** = undefined*/, quality?: number/** = 85*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
	/**
	 ...
	 * @async
	 */
	save(stm: Class_Stream, format?: number/** = undefined*/, quality?: number/** = 85*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	save(fname: string, format?: number/** = undefined*/, quality?: number/** = 85*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	colorReplace(src: number, dst: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 复制当前图像为一个新图像
	 * @return 返回复制的新图像对象
	 * @async
	 ...
	 * @async
	 */
	resample(width: number, height: number, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
	/**
	 ...
	 * @async
	 */
	crop(x: number, y: number, width: number, height: number, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
	/**
	 * @brief 镜像当前图像
	 * @param dir 镜像方向，允许值为 gd.BOTH,gd.HORIZONTAL, gd.VERTICAL, 缺省为 gd.HORIZONTAL
	 * @async
	 */
	flip(dir?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 旋转当前图像
	 * @param dir 旋转方向，允许值为 gd.LEFT, gd.RIGHT
	 * @async
	 */
	rotate(dir: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 * @brief 转换当前图像类型
	 * @param color 指定图像类型，允许值为 gd.TRUECOLOR 或 gd.PALETTE
	 * @async
	 */
	convert(color?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copy(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, width: number, height: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copyMerge(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, width: number, height: number, percent: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copyMergeGray(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, width: number, height: number, percent: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copyResized(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, dstW: number, dstH: number, srcW: number, srcH: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copyResampled(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, dstW: number, dstH: number, srcW: number, srcH: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	copyRotated(source: Class_Image, dstX: number, dstY: number, srcX: number, srcY: number, width: number, height: number, angle: number, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	filter(filterType: number, arg1?: number/** = 0*/, arg2?: number/** = 0*/, arg3?: number/** = 0*/, arg4?: number/** = 0*/, callback?:(err: Error, result: void)=>void): void;
	/**
	 ...
	 * @async
	 */
	affine(affine: any[], x?: number/** = -1*/, y?: number/** = -1*/, width?: number/** = -1*/, height?: number/** = -1*/, callback?:(err: Error, result: Class_Image)=>void): Class_Image;
	/**
	 * @brief 对当前图像进行高斯模糊处理
	 * @param radius 模糊半径
	 * @async
	 */
	gaussianBlur(radius: number, callback?:(err: Error, result: void)=>void): void;
} /** endof class */
