...
declare module "zlib" {
	module zlib {
		 ...
		 * @async
		 */
		export function deflate(data: Class_Buffer, level?: number/** = undefined*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function deflateTo(data: Class_Buffer, stm: Class_Stream, level?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function deflateTo(src: Class_Stream, stm: Class_Stream, level?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function inflate(data: Class_Buffer, maxSize?: number/** = -1*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function inflateTo(data: Class_Buffer, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function inflateTo(src: Class_Stream, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function gzip(data: Class_Buffer, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function gzipTo(data: Class_Buffer, stm: Class_Stream, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function gzipTo(src: Class_Stream, stm: Class_Stream, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function gunzip(data: Class_Buffer, maxSize?: number/** = -1*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function gunzipTo(data: Class_Buffer, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function gunzipTo(src: Class_Stream, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function deflateRaw(data: Class_Buffer, level?: number/** = undefined*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function deflateRawTo(data: Class_Buffer, stm: Class_Stream, level?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function deflateRawTo(src: Class_Stream, stm: Class_Stream, level?: number/** = undefined*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function inflateRaw(data: Class_Buffer, maxSize?: number/** = -1*/, callback?:(err: Error, result: Class_Buffer)=>void): Class_Buffer;
		/**
		 ...
		 * @async
		 */
		export function inflateRawTo(data: Class_Buffer, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
		/**
		 ...
		 * @async
		 */
		export function inflateRawTo(src: Class_Stream, stm: Class_Stream, maxSize?: number/** = -1*/, callback?:(err: Error, result: void)=>void): void;
	} /** end of `module zlib` */
	export = zlib
}
